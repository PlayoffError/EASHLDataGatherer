...
{
    public class GetPlayersByNameRequestTests
    {
        [Fact]
        void Constructor_Success()
        {
            ...
            GetPlayersByNameRequest request = new GetPlayersByNameRequest("Joe NHL 1", "PS5", webRequest, platformValidator );
        ...
        void URL_SubstituteValues()
        {
            ...
            request.URL.Should().Be($"https://proclubs.ea.com/api/nhl/members/search?platform=PS5&memberName=Joe+NHL+1");
        }
